...
from sqlalchemy.types import Integer, String, DateTime, DECIMAL, Date
from sqlalchemy import ForeignKey, func  # importa uma função geradora
...
class Reembolso(db.Model):
    ...
    id_colaborador = Column(
        Integer, ForeignKey(column="colaborador.id"), nullable=False
    )
    status = Column(String(30), nullable=False, default="Em análise")
